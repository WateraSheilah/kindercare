...
// this is for capturing the 0s and 1s by the pupil
...
// this is to sketch the character that the pupil has attempted
...
//array for comparing and the marking the character.
